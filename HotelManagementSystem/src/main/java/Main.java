                ...
                switch (choice1) {
                    ...
                    case 5:
                        ...
                        if (choice2 > 60)
                            ...
                            Hotel.service(choice2 - 41, 4);
                        else if (choice2 > 30)
                            Hotel.service(choice2 - 31, 3);
                        else if (choice2 > 10)
                            Hotel.service(choice2 - 11, 2);
                        else if (choice2 > 0)
                            Hotel.service(choice2 - 1, 1);
                        else
                            System.out.println("Room doesn't exist");
                        break;
                    case 6:
                    ...
                    case 7:
                        ...
                        if (choice2 > 60)
                            ...
                            Hotel.extendBooking(choice2 - 41, 4);
                        else if (choice2 > 30)
                            Hotel.extendBooking(choice2 - 31, 3);
                        else if (choice2 > 10)
                            Hotel.extendBooking(choice2 - 11, 2);
                        else if (choice2 > 0)
                            Hotel.extendBooking(choice2 - 1, 1);
                        else
                            System.out.println("Room doesn't exist");
                        break;
                    case 8:
